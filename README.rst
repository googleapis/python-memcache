...
`Cloud Memorystore for Memached API`_: Allows developers to manage billing for their Google Cloud Platform
...
3. `Enable the Cloud Memorystore for Memached API.`_
...
.. _Cloud Billing API Product documentation:  https://cloud.google.com/memorystore/docs/memcached/
